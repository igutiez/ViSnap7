...
<System.ComponentModel.Designer(GetType(VScrollBarDesigner))>
Public Class VS7_VScrollBar
    Inherits VScrollBar
...
Partial Public Class VS7_VScrollBar
    Inherits VScrollBar
...
Public Class VScrollBarDesigner
    ...
    Public Overrides ReadOnly Property ActionLists() As System.ComponentModel.Design.DesignerActionListCollection
        Get
            If _actionListCollection Is Nothing Then
                ...
                _actionListCollection.Add(New VScrollActionList(Me.Control))
            End If
...
Friend Class VScrollActionList
    Inherits DesignerActionList

    Private ctr As VS7_VScrollBar
    Private designerActionSvc As DesignerActionUIService

    Public Sub New(ByVal component As IComponent)
        MyBase.New(component)

        ctr = DirectCast(component, VS7_VScrollBar)
