...
Public Class UpdateFormDesigner
    ...
    Public Overrides ReadOnly Property ActionLists() As System.ComponentModel.Design.DesignerActionListCollection
        Get
            If _actionListCollection Is Nothing Then
                ...
                _actionListCollection.Add(New UpdateFormActionList(Me.Control))
            End If
...
Friend Class UpdateFormActionList
    Inherits DesignerActionList

    Private ctr As VS7_UpdateForm
    Private designerActionSvc As DesignerActionUIService

    Public Sub New(ByVal component As IComponent)
        MyBase.New(component)

        ctr = DirectCast(component, VS7_UpdateForm)
